-- ============================================
-- TAPTIP - MISE À JOUR DU SCHÉMA (safe)
-- ============================================
-- Ce script gère les cas où les tables existent déjà

-- ============================================
-- TABLE: badges (NOUVELLE)
-- ============================================
...
DROP POLICY IF EXISTS "Admin can create badges" ON badges;
DROP POLICY IF EXISTS "Users can activate badges" ON badges;
